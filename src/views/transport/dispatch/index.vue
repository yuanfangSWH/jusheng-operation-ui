    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="150px" inline>
      <div v-if="val">
        ...
        <el-form-item label="车型">
          <el-select clearable size="" value="">
        ...
        <el-form-item label="单价">
          ...
          <el-select clearable size="" value="">
            <el-option value="0" label="元/吨"></el-option>
            <el-option value="1" label="元/方"></el-option>
            <el-option value="2" label="元/件"></el-option>
            <el-option value="3" label="元/车"></el-option>
          </el-select>
        </el-form-item>
      ...
      <div v-else>
        ...
        <el-form-item label="所需船舶吨位">
          <el-input style="min-width: 100px; width: 100px" clearable></el-input>
          -
          <el-input style="min-width: 100px; width: 100px" clearable></el-input>
        </el-form-item>
        <el-form-item label="单价">
