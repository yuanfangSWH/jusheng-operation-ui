    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:companyInfo:add']"
          >新增</el-button
        >
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:companyInfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:companyInfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:companyInfo:export']"
        >导出</el-button>
      </el-col> -->
      <right-toolbar
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['system:companyInfo:list']"
            >查看部门</el-button
          >
        </template>
      </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['system:deptInfo:edit']"
              >修改</el-button
            >
            <el-button
              size="mini"
              ...
              v-hasPermi="[' system:deptInfo:remove']"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('system/companyInfo/export', {
        ...this.queryParams
      }, `system_info.xlsx`)
    }
  },
