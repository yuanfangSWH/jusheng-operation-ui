  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="250px"
      ></el-table-column>
      <el-table-column prop="sceneName" label="发放场景" width="150px">
      ...
      <el-table-column prop="sceneCash" label="返利金额" width="150px">
        <template slot-scope="data"> {{ data.row.sceneCash }}元 </template>
      </el-table-column>
      <el-table-column label="剩余/发行量" width="150px">
      ...
      <el-table-column
        ...
        width="150px"
      ></el-table-column>
      <el-table-column prop="isEnd" label="结束状态" width="150px">
        <template slot-scope="scope">
