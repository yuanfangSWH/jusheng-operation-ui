    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['consign:role:remove']"
          >删除</el-button
        >
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['consign:role:export']"
        >导出</el-button> 
      </el-col>-->
      <right-toolbar
      ...
      >
        ...
        <el-form-item label="菜单权限">
          ...
          <el-tree
            ...
            default-expand-all
          ></el-tree>
          <!-- <el-tree :data="menuOptions"  :props="defaultProps" show-checkbox node-key="id" default-expand-all ref="menu"></el-tree> -->
        </el-form-item>
...
<script>
import { listRole, getRole, delRole, addRole, updateRole, dataScope, changeRoleStatus } from "@/api/consign/role";
import { treeselect as menuTreeselect, roleMenuTreeselect } from "@/api/consign/menu";
import { treeselect as deptTreeselect, roleDeptTreeselect } from "@/api/consign/dept";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('consign/role/export', {
        ...this.queryParams
