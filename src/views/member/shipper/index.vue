  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="150px"
      ></el-table-column>
      <el-table-column prop="totalMoney" label="总额" width="130">
        <template slot-scope="data"> {{ data.row.totalMoney }}元 </template>
      </el-table-column>
      <el-table-column prop="usableMoney" label="可用余额" width="130">
        <template slot-scope="data"> {{ data.row.usableMoney }}元 </template>
      </el-table-column>
      <el-table-column prop="freezeMoney" label="冻结金额" width="130">
        <template slot-scope="data"> {{ data.row.freezeMoney }}元 </template>
      </el-table-column>
