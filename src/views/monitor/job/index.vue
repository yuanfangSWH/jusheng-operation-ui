        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="任务分组" prop="jobGroup">
              <el-select clearable v-model="form.jobGroup" placeholder="请选择">
                <el-option
                  v-for="dict in jobGroupOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
            ...
            <el-form-item prop="invokeTarget">
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    Bean调用示例：jushengTask.ryParams('ry')
                    <br />Class类调用示例：com.jusheng.quartz.task.JuShengTask.ryParams('ry')
