...
value-format="yyyy-MM-dd"
          ...
          <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
              <el-button
                ...
                size="mini"
                @click="handleAdd"
                v-hasPermi="['consign:user:add']"
                >新增
              </el-button>
            </el-col>
            <!-- <el-col :span="1.5">
              <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
                         v-hasPermi="['consign:user:edit']">修改
              </el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
                         @click="handleDelete"
                         v-hasPermi="['consign:user:remove']">删除
              </el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button type="info" plain icon="el-icon-upload2" size="mini" @click="handleImport"
                         v-hasPermi="['consign:user:import']">导入
              </el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                         v-hasPermi="['consign:user:export']">导出
              </el-button>
            </el-col> -->
            <right-toolbar
            ...
            >
              <template slot-scope="scope">
                ...
                <el-button
                  ...
                  v-hasPermi="['consign:user:remove']"
                  >删除
                </el-button>
                <el-button
                  v-if="scope.row.userId !== 1"
                  ...
                  v-hasPermi="['consign:user:roleList']"
                  >分配角色
                </el-button>
                <el-button
                  v-if="scope.row.userId !== 1"
                  ...
                  v-hasPermi="['consign:company:userCompanyList']"
                  >分配数据
                </el-button>
                <el-button
                  v-if="scope.row.userId !== 1"
                  ...
                  v-hasPermi="['consign:user:menuList']"
                  >分配权限
                </el-button>
              </template>
            </el-table-column>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          v-hasPermi="['consign:user:editUserRole']"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          v-hasPermi="['consign:company:editUserCompany']"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          v-hasPermi="['consign:user:editUserMenu']"
...
import {
  ...
  getUserCompanyList,
  updateUserCompanyID
} from '@/api/consign/user'
import {
  getToken
} from '@/utils/auth'
import {
  treeselect
} from '@/api/consign/dept'
...
export default {
  ...
  data () {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + '/consign/user/importData'
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('consign/user/export', {
        ...this.queryParams
    ...
    /** 下载模板操作 */
    importTemplate () {
      this.download('consign/user/importTemplate', {
        ...this.queryParams
      }, `user_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
