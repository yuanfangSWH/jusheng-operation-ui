...
export default {
  ...
  methods: {
    ...
    disappearIMG (key) {
      ...
      this.urls[key].url = "https://ycc.yunsd56.com/files/51010d6e5c8048348b111f1335e60314.jpeg";
    ...
    queryDriverById () {
      queryDriverById({ chauffeurId: this.form.chauffeurId }).then((res) => {
        if (res.code == 200) {
          ...
          this.form.cyCertificateTwo = res.data.cyCertificateTwo
          //处理图片
          if (this.form?.idCardPerson) {
            ...
            this.urls.push({
              name: '身份证头像面',
              value: 'idCardPerson',
              url: 'https://ycc.yunsd56.com/files/51010d6e5c8048348b111f1335e60314.jpeg'
            })
          }
          ...
          if (this.form?.cyCertificateTwo) {
            this.urls.push({
              name: '从业资格证2',
              value: 'cyCertificateTwo',
              url: this.form.cyCertificateTwo
            })
          } else {
            this.urls.push({
              name: '从业资格证2',
