  ...
  <div class="app-container">
    ...
    <el-row class="ma20">
      <el-col :span="6">
        ...
        <span class="val">{{ form.freightTotal }}元</span>
      </el-col>
      <el-col :span="6">
        <span class="mr20 label">运单未付金额</span>
        <span class="val">{{ form.unpaidFreight }}元</span>
      </el-col>
      <el-col :span="6">
        <div>
          <span class="mr20 label">本次申请支付运费</span>
          <span class="val"
            >{{ form.chauffeurMoney + form.anotherPayeeMoney }}元</span
          >
        </div>
        <div>
          <span class="mr20 label">第二收款人收款</span>
          <span class="val">{{ form.anotherPayeeMoney }}元</span>
        </div>
        <div>
          <span class="mr20 label">司机收款</span>
          <span class="val">{{ form.chauffeurMoney }}元</span>
        </div>
      </el-col>
    </el-row>
    <el-row class="ma20">
    ...
    <el-row class="ma20">
      ...
      <el-col :span="6">
        ...
        <span class="val"
          >{{ form.payeeName }}/{{ form.accountBank }}/{{
            form.idCardPhone
          }}</span
        >
      </el-col>
      <el-col :span="6">
        ...
        <span
          class="val"
          v-if="
            form.anotherPayeeName != '' &&
            String(form.anotherPayeeName) != 'null'
          "
          >{{ form.kaihuName }}/{{ form.drAccountBank }}/{{
            form.drPayeePhone
          }}</span
        >
    ...
    <el-table class="mb20" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="name" label="承运司机"></el-table-column>
      <el-table-column prop="phone" label="承运司机手机号"></el-table-column>
    ...
    paymentAudit () {
      ...
      paymentAudit({ auditState: this.form.auditState, checkRemake: this.form.checkRemake, payApplyCodes: String(this.form.payApplyCode) }).then(res => {
        if (res.code == 200) {
          ...
          this.$router.push({ path: "/business/paymentAudit" })
        }
      })
    },
    //详情
