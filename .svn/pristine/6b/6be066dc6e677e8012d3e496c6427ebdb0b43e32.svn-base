<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="150px" inline>
      ...
      <div class="mb20">
        <el-divider content-position="left">第二收款人 </el-divider>
      </div>
      <el-row>
        <el-col :span="6"
          ><el-form-item label="第二收款人">
            {{ form.kaihuName }}/{{ form.payeePhone }}
          </el-form-item></el-col
        >
        <el-col :span="6"
          ><el-form-item label="第二收款人收款金额">
            {{ form.drPaymentAmount }}元</el-form-item
          ></el-col
        >
        <el-col :span="6"
          ><el-form-item label="司机收款金额">
            {{ sjPaymentAmount }}元
          </el-form-item></el-col
        >
        <el-col :span="6"
