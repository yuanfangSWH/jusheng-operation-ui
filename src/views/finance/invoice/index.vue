<template>
  <div class="app-container">
    ...
    <div class="mb20">
      <div>
        <el-button class="mr5" type="danger" @click="fallbackInvoice"
          >退回</el-button
        >
        <el-button type="warning" @click="exportInvoice">导出</el-button>
      </div>
    </div>
    <!-- table表格区域 -->
    <el-table
    ...
    >
      ...
      <el-table-column prop="applyCode" label="申请单编号" width="200px">
      ...
      <el-table-column prop="invoiceStatus" label="开票状态">
        <template slot-scope="data">
          ...
          <span v-else-if="data.row.invoiceStatus == 1">已开</span>
        </template>
      </el-table-column>
...
<script>
import { fallbackInvoice, getList, exportInvoice } from "@/api/finance/invoice";
  ...
  methods: {
    ...
    exportInvoice () {
      let data = {
        ...
        invoiceStatus: String(this.invoiceStatus)
      }
      exportInvoice(data).then(res => {
        //通用下载方法
