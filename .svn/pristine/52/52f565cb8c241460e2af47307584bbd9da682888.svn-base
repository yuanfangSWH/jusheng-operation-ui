      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <span slot="label">
            生成包路径
            <el-tooltip
              content="生成在哪个java包下，例如 com.jusheng.system"
              placement="top"
            >
    ...
    <el-row v-show="info.tplCategory == 'tree'">
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-select clearable v-model="info.treeCode" placeholder="请选择">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-select clearable v-model="info.treeName" placeholder="请选择">
            <el-option
              v-for="(column, index) in info.columns"
              :key="index"
              :label="column.columnName + '：' + column.columnComment"
