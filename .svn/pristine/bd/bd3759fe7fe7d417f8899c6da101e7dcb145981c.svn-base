  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="150px"
      ></el-table-column>
      <el-table-column prop="invoiceDetail" label="发票图片文件" width="150px">
        <template slot-scope="data">
          <el-button
            size="mini"
            type="primary"
      ...
      <el-table-column prop="auditStatus" label="审核状态" width="180px">
        <template slot-scope="scope">
          <span v-if="scope.row.auditStatus == 0" style="color: #909399"
            >待审核</span
          >
          <span v-else-if="scope.row.auditStatus == 1" style="color: #e6a23c"
            >审核中</span
          >
          <span v-else-if="scope.row.auditStatus == 2" style="color: #67c23a"
            >审核通过</span
          >
          <span v-else-if="scope.row.auditStatus == 3" style="color: #f56c6c"
            >审核不通过</span
          >
        </template>
      </el-table-column>
